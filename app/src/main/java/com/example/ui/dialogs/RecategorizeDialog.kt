...
fun RecategorizeDialog(
    ...
    onDismiss: () -> Unit,
    onConfirm: (newCategory: String) -> Unit
) {
    ...
    Dialog(onDismissRequest = onDismiss) {
        Card(
            ...
            Column(
                ...
                Text(
                    text = "Re-categorizing '${transaction.merchant}' will train the on-device ML model for future Google Messages SMS parsing.",
